...
func main() {
  ...
  if err != nil || d <= 0 {
    fmt.Println("ERROR Invalid number n provided.")
  ...
  fmt.Printf(" digits of %s starting at position %s: ",
    args[0], args[1])
  if err != nil {
...
func help(filename string) {
  fmt.Println("This program computes n-th digit of binary log2 or hexadecimal pi.")
